...
public class Select
{
    ...
    public String toStatementString()
    {
        ...
        sbSelect.append("select ").append(this.selectClause).append(" from ").append(this.fromClause);
        ...
        if ((!StringUtil.IsNullOrEmpty(this.whereClause)) || (!StringUtil.IsNullOrEmpty(this.outerJoinsAfterWhere)))
        {
